...
// Source: github.com/aspect-build/talkie/examples/helloworld_http/protos (interfaces: GreeterClient)
...
import (
	...
	protos "github.com/aspect-build/talkie/examples/helloworld_http/protos"
...
func (m *MockGreeterClient) SayHello(arg0 context.Context, arg1 *protos.HelloRequest, arg2 ...grpc.CallOption) (*protos.HelloReply, error) {
	...
	ret0, _ := ret[0].(*protos.HelloReply)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
